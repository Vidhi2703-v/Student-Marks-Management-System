...
This project is designed to simulate a basic student performance tracking system that enables structured data storage, analysis, and evaluation using core Python concepts.
